...
activities = {
    ...
    "Basketball Club": {
        "description": "Develop shooting, passing, and defensive skills in a friendly team environment",
    ...
    "Science Olympiad": {
        "description": "Solve challenging science problems and compete in STEM-based events",
        "schedule": "Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 12,
        "participants": ["harper@mergington.edu"]
    },
    "Debate Team": {
        "description": "Research topics, build arguments, and practice public speaking skills",
